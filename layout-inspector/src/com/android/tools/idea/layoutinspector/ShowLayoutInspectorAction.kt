...
import com.android.tools.idea.layoutinspector.runningdevices.actions.TOGGLE_EMBEDDED_LAYOUT_INSPECTOR_ACTION_ID
...
class ShowLayoutInspectorAction :
  ...
  override fun actionPerformed(e: AnActionEvent) {
    ...
    if (LayoutInspectorSettings.getInstance().embeddedLayoutInspectorEnabled) {
      ...
      activateStandaloneLayoutInspectorToolWindow(project)
    }
  }
}
...
private fun activateStandaloneLayoutInspectorToolWindow(project: Project) {
