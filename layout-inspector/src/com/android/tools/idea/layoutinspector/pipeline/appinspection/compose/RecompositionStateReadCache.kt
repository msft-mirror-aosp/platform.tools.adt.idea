...
class RecompositionStateReadCache(
   ...
   */
  private class LruCache : LinkedHashMap<Key, StateReadNode>(16, 0.75f, true) {
    private val top = mutableMapOf<Int, StateReadNode>()

    override fun get(key: Key): StateReadNode? {
    ...
    override fun remove(key: Key): StateReadNode {
      error("Not implemented")
    }

    override fun removeEldestEntry(eldest: Map.Entry<Key, StateReadNode>): Boolean {
    ...
    fun closest(key: Key, searchUp: Boolean): StateReadNode? {
