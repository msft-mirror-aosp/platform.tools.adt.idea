...
class NamedIdeaSourceProviderImpl(override val name: String, override val scopeType: ScopeType, val core: Core) : NamedIdeaSourceProvider {
  ...
  override val baselineProfileDirectoryUrls: Iterable<String>
    get() = core.baselineProfileDirectoryUrls.asIterable()
 ...
 * resolving them dynamically so that changes to the set of files that exist at any given moment are picked up.
 */
class IdeaSourceProviderImpl(override val scopeType: ScopeType, val core: Core) : IdeaSourceProvider {
  ...
  override val manifestFileUrls: Iterable<String>
    get() = core.manifestFileUrls.asIterable()

  override val manifestDirectoryUrls: Iterable<String>
    get() = core.manifestDirectoryUrls.asIterable()
  ...
  override val manifestDirectories: Iterable<VirtualFile>
    get() = core.manifestDirectoryUrls.toVirtualFiles()
...
interface NamedIdeaSourceProviderBuilder {
  ...
  private data class Builder(
    ...
    override fun withRenderscriptDirectoryUrls(urls: Collection<String>): NamedIdeaSourceProviderBuilder =
      copy(renderscriptDirectoryUrls = urls)
    ...
    override fun withBaselineProfileDirectoryUrls(urls: Collection<String>): NamedIdeaSourceProviderBuilder =
      ...
      NamedIdeaSourceProviderImpl(
        ...
        object : NamedIdeaSourceProviderImpl.Core {
          override val manifestFileUrl: String
            get() = this@Builder.manifestFileUrl

          override val javaDirectoryUrls: Sequence<String>
            get() = this@Builder.javaDirectoryUrls.asSequence()

          override val kotlinDirectoryUrls: Sequence<String>
            get() = this@Builder.kotlinDirectoryUrls.asSequence()

          override val resourcesDirectoryUrls: Sequence<String>
            get() = this@Builder.resourcesDirectoryUrls.asSequence()

          override val aidlDirectoryUrls: Sequence<String>
            get() = this@Builder.aidlDirectoryUrls.asSequence()

          override val renderscriptDirectoryUrls: Sequence<String>
            get() = this@Builder.renderscriptDirectoryUrls.asSequence()

          override val jniLibsDirectoryUrls: Sequence<String>
            get() = this@Builder.jniLibsDirectoryUrls.asSequence()

          override val resDirectoryUrls: Sequence<String>
            get() = this@Builder.resDirectoryUrls.asSequence()

          override val assetsDirectoryUrls: Sequence<String>
            get() = this@Builder.assetsDirectoryUrls.asSequence()

          override val shadersDirectoryUrls: Sequence<String>
            get() = this@Builder.shadersDirectoryUrls.asSequence()

          override val mlModelsDirectoryUrls: Sequence<String>
            get() = this@Builder.mlModelsDirectoryUrls.asSequence()

          override val customSourceDirectories: Map<String, Sequence<String>> =
            this@Builder.customSourceDirectories.mapValues { it.value.asSequence() }
          override val baselineProfileDirectoryUrls: Sequence<String>
            get() = this@Builder.baselineProfileDirectoryUrls.asSequence()
...
private class CustomImpl(private val _directoryUrls: Sequence<String>) : IdeaSourceProvider.Custom {
  override val directoryUrls: Iterable<String>
    get() = _directoryUrls.asIterable()

  override val directories: Iterable<VirtualFile>
    get() = _directoryUrls.toVirtualFiles()
}
