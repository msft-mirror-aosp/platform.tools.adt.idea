...
class GenerateBundleAction : AnAction(ACTION_TEXT) {
  ...
  override fun update(e: AnActionEvent) {
    ...
    val isSupported = BuildBundleActionToken.isSupported(project)
  ...
  companion object {
    private const val ACTION_TEXT = "Generate Bundles"
  }
}
