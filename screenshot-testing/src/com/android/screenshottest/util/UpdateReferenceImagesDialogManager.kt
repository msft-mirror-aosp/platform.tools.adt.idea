...
class UpdateReferenceImagesDialogManager(private val project: Project) : Disposable {
  ...
  @VisibleForTesting var dialogFactory: (Project) -> UpdateReferenceImagesDialog = { UpdateReferenceImagesDialog(it) }

  /**
   * Checks if a dialog is already open for the project. If open, it brings it to the front and returns null. If not open, it creates a new
