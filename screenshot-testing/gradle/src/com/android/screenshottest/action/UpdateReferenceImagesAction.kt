...
/**
 * Action to add or update the reference images for screenshot tests. This action must be stateless, as the IDE creates a single instance.
 */
class UpdateReferenceImagesAction :
