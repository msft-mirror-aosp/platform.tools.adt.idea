...
class AndroidLintIdeSupport : LintIdeSupport() {
  ...
  override fun createClient(project: Project, lintResult: LintResult) = AndroidLintIdeClient(project, lintResult)

  override fun createBatchClient(lintResult: LintBatchResult) = AndroidLintIdeClient(lintResult.project, lintResult)

  override fun createEditorClient(lintResult: LintEditorResult) = AndroidLintIdeClient(lintResult.getModule().project, lintResult)
