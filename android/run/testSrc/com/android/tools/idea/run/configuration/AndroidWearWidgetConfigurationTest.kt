...
class AndroidWearWidgetConfigurationTest {
  ...
  fun testProgramRunnerAvailable() {
    val configSettings =
      RunManager.getInstance(project)
        .createConfiguration("run widget", AndroidWearWidgetConfigurationType().configurationFactories.single())
  ...
  fun testDefaultMakeTaskIsDisabled() {
    val factory = AndroidWearWidgetConfigurationType().configurationFactories.single()
