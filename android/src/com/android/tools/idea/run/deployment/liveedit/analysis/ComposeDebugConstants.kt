...
//
// See:
// https://developer.android.com/reference/kotlin/androidx/compose/runtime/package-summary#sourceInformation(androidx.compose.runtime.Composer,kotlin.String)
...
private fun isSourceInfoCall(insn: IrInstruction) =
  insn.opcode == Opcodes.INVOKESTATIC && insn.params[0] as? String == kComposerClass && insn.params[1] as? String == kSourceInfo

private fun isSourceInfoMarkerCall(insn: IrInstruction) =
  insn.opcode == Opcodes.INVOKESTATIC && insn.params[0] as? String == kComposerClass && insn.params[1] as? String == kSourceInfoMarker

private fun isTraceEventCall(insn: IrInstruction) =
  insn.opcode == Opcodes.INVOKESTATIC && insn.params[0] as? String == kComposerClass && insn.params[1] as? String == kTraceEventStart
