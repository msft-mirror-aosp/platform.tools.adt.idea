...
private constructor(val error: Error, val details: String = "", val sourceFilename: String?, cause: Throwable?) :
  ...
  companion object {
    ...
    /**
     * We are unable to locate the Invalidate Group ID of a given Composable function's offsets. This is unlikely to happen unless the
     * Compose compiler changes how the offset-to-ID mapping works.
     */
