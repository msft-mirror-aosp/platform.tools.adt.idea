...
public class AndroidSdksImpl implements AndroidSdks {

  @NotNull private final IdeInfo myIdeInfo;
  @Nullable private AndroidSdkData mySdkData;

  public AndroidSdksImpl() {
    this(IdeInfo.getInstance());
  }

  @NonInjectable
  @VisibleForTesting
  public AndroidSdksImpl(@NotNull IdeInfo ideInfo) {
    myIdeInfo = ideInfo;
  }
  ...
  @NotNull
  private List<VirtualFile> getPlatformAndAddOnJars(@NotNull IAndroidTarget target) {
  ...
  @Override
  @VisibleForTesting
  public void replaceLibraries(@NotNull Sdk sdk, @NotNull VirtualFile[] libraries) {
