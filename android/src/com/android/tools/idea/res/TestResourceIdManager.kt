...
class TestResourceIdManager private constructor() : StubbedResourceIdManager(StudioFlags.USE_BYTECODE_R_CLASS_PARSING.get()) {
  ...
  companion object {
    @TestOnly fun createManagerForTest() = TestResourceIdManager()
  }
}
