...
/**
 * [Remapper] that renames all references to [org.jetbrains.compose.ui.tooling.preview.PreviewParameterProvider] with the
 * [androidx.compose.ui.tooling.preview.PreviewParameterProvider]. The names used are JVM internal names and thus separated with "/".
 */
...
internal fun Remapper.chainWith(remapper: Remapper): Remapper =
  object : Remapper() {
    override fun map(internalName: String?): String? {
