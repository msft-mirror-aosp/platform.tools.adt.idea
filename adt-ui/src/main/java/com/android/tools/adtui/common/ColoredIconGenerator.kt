...
object ColoredIconGenerator {
   ...
   *
   * The alpha value of the source icon is maintained. It is assumed that the alpha of the target [color] is 1. Note: that the actual
   * instance of [color] may be an [JBColor] and we may end up with 3 different icons in the cache created.
   */
  fun generateColoredIcon(icon: Icon, color: Color): Icon =
