...
public class MyClass {
  public void methodUiThreadA() {
    ThreadingCheckerTrampoline.verifyOnUiThread();
  }

  public void methodUiThreadB() {
    ThreadingCheckerTrampoline.verifyOnUiThread();
  }

  public void methodWorkerThreadA() {
    ThreadingCheckerTrampoline.verifyOnWorkerThread();
  }

  public void methodWorkerThreadB() {
    ThreadingCheckerTrampoline.verifyOnWorkerThread();
  }

  public void methodReadLockA() {
    ThreadingCheckerTrampoline.verifyReadLock();
  }

  public void methodReadLockB() {
    ThreadingCheckerTrampoline.verifyReadLock();
  }

  public void methodWriteLockA() {
    ThreadingCheckerTrampoline.verifyWriteLock();
  }

  public void methodWriteLockB() {
    ThreadingCheckerTrampoline.verifyWriteLock();
  }

  public void methodNoReadLockA() {
    ThreadingCheckerTrampoline.verifyNoReadLock();
  }

  public void methodNoReadLockB() {
    ThreadingCheckerTrampoline.verifyNoReadLock();
  }
}
