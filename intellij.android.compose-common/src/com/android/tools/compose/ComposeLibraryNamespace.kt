...
const val MULTIPLATFORM_UI_TOOLING_PACKAGE = "org.jetbrains.compose.ui.tooling"
const val MULTIPLATFORM_UI_TOOLING_PREVIEW_PACKAGE = "$MULTIPLATFORM_UI_TOOLING_PACKAGE.preview"
...
const val COMPOSE_PREVIEW_WRAPPER_ANNOTATION_FQN = "$COMPOSE_UI_TOOLING_PREVIEW_PACKAGE.PreviewWrapper"
...
const val COMPOSE_WALLPAPERS_CLASS_FQN = "$COMPOSE_UI_TOOLING_PREVIEW_PACKAGE.Wallpapers"

const val MULTIPLATFORM_PREVIEW_ANNOTATION_FQN = "$MULTIPLATFORM_UI_TOOLING_PREVIEW_PACKAGE.$COMPOSE_PREVIEW_ANNOTATION_NAME"
const val MULTIPLATFORM_PREVIEW_PARAMETER_ANNOTATION_FQN = "$MULTIPLATFORM_UI_TOOLING_PREVIEW_PACKAGE.PreviewParameter"
