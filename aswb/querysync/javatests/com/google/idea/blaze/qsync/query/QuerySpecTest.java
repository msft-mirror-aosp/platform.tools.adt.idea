...
public class QuerySpecTest {
  ...
  public void testGetQueryExpression_experimental_includes_and_excludes() {
    ...
    assertThat(qs.getQueryExpression())
        .hasValue(
            "let base = //some/included/path/...:* + //another/included/path/...:* -"
                + " //some/included/path/excluded/...:* - //another/included/path/excluded/...:*\n"
                + " in let known = kind(\"source"
                + " file|android_library|android_binary|android_local_test|_wrapped_android_local_test|android_instrumentation_test|kt_android_library_helper|kt_android_library|java_library|java_binary|kt_jvm_library|kt_jvm_binary|kt_jvm_library_helper|kt_native_library|java_test|kt_jvm_test|java_proto_library|java_lite_proto_library|java_mutable_proto_library|_java_grpc_library|_kotlin_library|_java_lite_grpc_library|_iml_module_|_iml_test_module_|cc_library|cc_binary|cc_shared_library|cc_test|ndk_cc_library_rule|ndk_cc_dynamic_library_force_android_rule|proto_library|alias\","
                + " $base) \n"
