...
public class CcProjectModelUpdater implements QuerySyncProjectListener {
  ...
  @Override
  public void onNewProjectStructure(
      Context<?> context,
      ReadonlyQuerySyncProject querySyncProject,
      QuerySyncProjectSnapshot instance) {
    updateProjectModel(querySyncProject, instance.getProject(), context);
  }
  ...
  public void updateProjectModel(
    ...
    CcProjectModelUpdateOperation updateOp =
        new CcProjectModelUpdateOperation(
            context, readonlyOcWorkspace, querySyncProject.getProjectPathResolver());
    try {
