 ...
 */
package com.google.idea.bazel.skylark.debugger.run;

import com.google.idea.bazel.skylark.debugger.SkylarkDebuggingUtils;
import com.google.idea.bazel.skylark.debugger.impl.SkylarkDebugProcess;
...
public class SkylarkDebugRunner extends GenericProgramRunner<RunnerSettings> {

  public SkylarkDebugRunner() {}
  ...
  @Nullable
  @Override
  public RunContentDescriptor doExecute(RunProfileState state, ExecutionEnvironment env)
            ...
            new XDebugProcessStarter() {
              ...
              public XDebugProcess start(XDebugSession session) {
                EventLoggingService.getInstance()
                    .log(
                        new GenericEvent(
                            env.getProject(), SkylarkDebugRunner.class, "skylark-debugging"));
