...
interface BinaryContextProvider {
   ...
   */
  fun getRunContext(context: ConfigurationContext): RunConfigurationContext?
  ...
  companion object {
    ...
    @JvmStatic
    fun createRunContext(sourceElement: PsiElement, target: TargetInfo): UnifiedRunContext {
