 ...
 */
package com.google.idea.bazel.java.run.hotswap;
...
public interface JavaClasspathAspectStrategy {
  ...
  class BazelStrategy implements JavaClasspathAspectStrategy {
    ...
    public ImmutableList<String> getBuildFlags(BlazeVersionData versionData) {
      ...
      intellijAspect =
          compat.makeAspectFromInjectedRepositoryFlag(
              "intellij_aspect", "java_classpath.bzl%java_classpath_aspect");
    ...
    private static File findAspectDirectory() {
      PluginDescriptor plugin = PluginManager.getPluginByClass(BlazeBuildOutputs.class);
      return plugin.getPluginPath().resolve("aspect").toFile();
    }
  }
}
