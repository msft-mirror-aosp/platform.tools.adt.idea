...
/**
 * Class to handle listeners and calls. This class is thread-safe and handles the case where listeners add or remove listeners during their
 * execution.
 *
 * Please note that you may consider to use a more efficient ContainerUtil.createLockFreeCopyOnWriteList instead of this class.
 *
...
class ListenerCollection<T : Any> private constructor(private val myExecutor: Executor) {
  ...
  @GuardedBy("myLock") private val myListenersSet = HashSet<T>()
