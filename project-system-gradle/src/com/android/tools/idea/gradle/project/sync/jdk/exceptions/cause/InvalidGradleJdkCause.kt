...
import com.google.wireless.android.sdk.stats.GradleJdkInvalidEvent.InvalidJdkReason.INVALID_JDK_PROJECT_JDK_UNDEFINED
...
sealed class InvalidGradleJdkCause(val description: String, val reason: InvalidJdkReason) {
  ...
  object InvalidProjectJdk :
    InvalidGradleJdkCause(AndroidBundle.message("project.sync.exception.gradle.project.jdk.invalid"), INVALID_JDK_PROJECT_JDK_UNDEFINED)
