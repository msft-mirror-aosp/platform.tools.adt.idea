...
class BuildApkActionTokenGradle : BuildApkActionToken<GradleProjectSystem>, GradleToken {
  ...
  override fun buildApk(project: Project) {
    val appModules =
    ...
    if (appModules.isNotEmpty()) {
      ...
      val task = GoToApkLocationTask(project, appModules, "Generate APKs")
