...
data class GradleProjectSystemIntegrationTest(
  ...
  companion object {
    val tests =
      listOf(
        GradleProjectSystemIntegrationTest(name = "manifestOverrides", testProject = TestProject.MULTI_FLAVOR) { project, agpVersion, expect
          ->
        ...
        GradleProjectSystemIntegrationTest(name = "manifestOverridesInLibrary", testProject = TestProject.INCLUDE_FROM_LIB) {
          project,
          agpVersion,
          expect ->
        ...
        GradleProjectSystemIntegrationTest(name = "manifestOverridesInSeparateTest", testProject = TestProject.TEST_ONLY_MODULE) {
          project,
          agpVersion,
          expect ->
        ...
        GradleProjectSystemIntegrationTest(name = "packageName", testProject = TestProject.MULTI_FLAVOR) { project, agpVersion, expect ->
        ...
        GradleProjectSystemIntegrationTest(name = "isValidAndroidManifestPackage", testProject = TestProject.TRANSITIVE_DEPENDENCIES) {
          project,
          agpVersion,
          expect ->
          ...
          listOf(
            ...
            .forEach { packageName ->
              expect
                .that(projectSystem.isNamespaceOrParentPackage(packageName))
        ...
        GradleProjectSystemIntegrationTest(name = "module_allApplicationIds", testProject = TestProject.MULTI_FLAVOR) {
          project,
          agpVersion,
          expect ->
        ...
        GradleProjectSystemIntegrationTest(name = "knownApplicationIds", testProject = TestProject.MULTI_FLAVOR) {
          project,
          agpVersion,
          expect ->
        ...
        GradleProjectSystemIntegrationTest(name = "knownApplicationIds", testProject = TestProject.TRANSITIVE_DEPENDENCIES) {
          project,
          agpVersion,
          expect ->
          val appIds = project.getProjectSystem().getKnownApplicationIds(project)
        ...
        GradleProjectSystemIntegrationTest(name = "knownApplicationIds", testProject = TestProject.PSD_SAMPLE_GROOVY) {
          project,
          agpVersion,
          expect ->
          val appIds = project.getProjectSystem().getKnownApplicationIds(project)
        ...
        GradleProjectSystemIntegrationTest(name = "findModulesWithApplicationId", testProject = TestProject.PSD_SAMPLE_GROOVY) {
          project,
          agpVersion,
          expect ->
          fun doLookup(applicationId: String) = project.getProjectSystem().findModulesWithApplicationId(applicationId).map { it.name }
        ...
        GradleProjectSystemIntegrationTest(name = "pseudoLocalesToken", testProject = TestProject.PSD_SAMPLE_GROOVY) {
          project,
          agpVersion,
          expect ->
          ...
          expect
            .that(doLookup("com.example.psd.sample.app.default.test"))
            .isEqualTo(PseudoLocalesToken.PseudoLocalesState.ENABLED) // tested build type is debug
          expect
            .that(doLookup("com.example.psd.sample.app.defaultSuffix"))
            .isEqualTo(PseudoLocalesToken.PseudoLocalesState.BOTH) // used for both debug and specialRelease
          expect
            .that(doLookup("com.example.psd.sample.app.defaultSuffix.barSuffix"))
            .isEqualTo(PseudoLocalesToken.PseudoLocalesState.BOTH) // used for both debug and specialRelease
          expect
            .that(doLookup("com.example.psd.sample.app.defaultSuffix.barSuffix.suffix"))
            .isEqualTo(PseudoLocalesToken.PseudoLocalesState.DISABLED)
          ...
          expect
            .that(doLookup("com.example.psd.sample.app.paid.test"))
            .isEqualTo(PseudoLocalesToken.PseudoLocalesState.ENABLED) // tested build type is debug
          expect
            .that(doLookup("com.example.psd.sample.app.paid.defaultSuffix"))
            .isEqualTo(PseudoLocalesToken.PseudoLocalesState.BOTH) // used for both debug and specialRelease
          expect
            .that(doLookup("com.example.psd.sample.app.paid.defaultSuffix.barSuffix"))
            .isEqualTo(PseudoLocalesToken.PseudoLocalesState.BOTH) // used for both debug and specialRelease
          expect
            .that(doLookup("com.example.psd.sample.app.paid.defaultSuffix.barSuffix.suffix"))
            .isEqualTo(PseudoLocalesToken.PseudoLocalesState.DISABLED)
          expect
            .that(doLookup("com.example.psd.sample.app.paid.defaultSuffix.suffix"))
            .isEqualTo(PseudoLocalesToken.PseudoLocalesState.DISABLED)
        },
        GradleProjectSystemIntegrationTest(name = "getResolvedDependency", testProject = TestProject.SIMPLE_APPLICATION) {
          project,
          agpVersion,
          expect ->
