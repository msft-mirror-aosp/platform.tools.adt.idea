...
enum class TestFileNameImpl(@TestDataFile val path: String) : TestFileName {
  ...
  TEST_OPTIONS_MODEL_ADD_EXISTING_TEST_SUITE_EXPECTED("testOptionsModel/addExistingTestSuiteExpected"),
  TEST_SUITE_MODEL_PARSE_ELEMENTS("testSuiteModel/parseElements"),
  TEST_SUITE_MODEL_PARSE_ELEMENTS_VERSION_CATALOG("testSuiteModel/parseElements.versions.toml"),
  TEST_SUITE_MODEL_ADD_ELEMENTS("testSuiteModel/addElements"),
  TEST_SUITE_MODEL_ADD_ELEMENTS_VERSION_CATALOG("testSuiteModel/addElements.versions.toml"),
  TEST_SUITE_MODEL_ADD_ELEMENTS_EXPECTED("testSuiteModel/addElementsExpected"),
  TEST_SUITE_MODEL_EDIT_ELEMENTS_EXPECTED("testSuiteModel/editElementsExpected"),
  ...
  REFERENCE_RESOLUTION_FROM_VERSION_CATALOG("referenceResolution/resolveVersionFromCatalog"),
