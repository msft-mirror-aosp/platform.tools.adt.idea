...
class KotlinTypeUtilsKtTest {
  ...
  @Test
  fun checkInteger() {
    val type = builtIn.getKotlinType(typeStr = "integer", defaultValue = null, moduleDescriptor = moduleDescriptor)
  ...
  @Test
  fun checkFloat() {
    val type = builtIn.getKotlinType(typeStr = "float", defaultValue = null, moduleDescriptor = moduleDescriptor)
  ...
  @Test
  fun checkLong() {
    val type = builtIn.getKotlinType(typeStr = "long", defaultValue = null, moduleDescriptor = moduleDescriptor)
  ...
  @Test
  fun checkBoolean() {
    val type = builtIn.getKotlinType(typeStr = "boolean", defaultValue = null, moduleDescriptor = moduleDescriptor)
  ...
  @Test
  fun checkString() {
    val type = builtIn.getKotlinType(typeStr = "string", defaultValue = null, moduleDescriptor = moduleDescriptor)
  ...
  fun checkResourceReference() {
    val type = builtIn.getKotlinType(typeStr = "reference", defaultValue = null, moduleDescriptor = moduleDescriptor)
    assertThat(type).isEqualTo(builtIn.intType)
  }
  ...
  fun checkCustomType() {
    val type =
      builtIn.getKotlinType(typeStr = "test.safeargs.MyCustomType", defaultValue = null, moduleDescriptor = moduleDescriptor) as ErrorType
  ...
  fun checkCustomTypeArray() {
    val type = builtIn.getKotlinType(typeStr = "test.safeargs.MyCustomType[]", defaultValue = null, moduleDescriptor = moduleDescriptor)
  ...
  fun checkInferredInteger() {
    val type = builtIn.getKotlinType(typeStr = null, defaultValue = "1", moduleDescriptor = moduleDescriptor)
    assertThat(type).isEqualTo(builtIn.intType)
  }

  @Test
  fun checkInferredFloat() {
    val type = builtIn.getKotlinType(typeStr = null, defaultValue = "1f", moduleDescriptor = moduleDescriptor)
    assertThat(type).isEqualTo(builtIn.floatType)
  }

  @Test
  fun checkInferredLong() {
    val type = builtIn.getKotlinType(typeStr = null, defaultValue = "1L", moduleDescriptor = moduleDescriptor)
    assertThat(type).isEqualTo(builtIn.longType)
  }

  @Test
  fun checkInferredBoolean() {
    val type = builtIn.getKotlinType(typeStr = null, defaultValue = "true", moduleDescriptor = moduleDescriptor)
    assertThat(type).isEqualTo(builtIn.booleanType)
  }

  @Test
  fun checkInferredString() {
    val type = builtIn.getKotlinType(typeStr = null, defaultValue = "someString", moduleDescriptor = moduleDescriptor)
    assertThat(type).isEqualTo(builtIn.stringType)
  }

  @Test
  fun checkInferredNullString() {
    val type = builtIn.getKotlinType(typeStr = null, defaultValue = "@null", moduleDescriptor = moduleDescriptor)
  ...
  fun checkInferredResourceReference() {
    val type = builtIn.getKotlinType(typeStr = null, defaultValue = "@resourceType/resourceName", moduleDescriptor = moduleDescriptor)
    assertThat(type).isEqualTo(builtIn.intType)
  }
  ...
  fun checkNullableString() {
    val type = builtIn.getKotlinType(typeStr = "string", defaultValue = null, moduleDescriptor = moduleDescriptor, isNonNull = false)
