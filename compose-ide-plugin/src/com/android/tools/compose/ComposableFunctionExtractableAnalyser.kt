...
class ComposableFunctionExtractableAnalyser : AdditionalExtractableAnalyser {
   ...
   *
   * Example: fun myFunction(context: @Composable () -> Unit) If given [KtLambdaArgument] corresponds to context parameter function returns
   * [AnnotationDescriptor] for @Composable.
   */
