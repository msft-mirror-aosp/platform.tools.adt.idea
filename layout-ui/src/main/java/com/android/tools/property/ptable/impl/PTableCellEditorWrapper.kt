 ...
 *
 * A thin wrapper around a [PTableCellEditor] that can be used in a [JTable]. By default a [DefaultPTableCellEditor] is used, but it can be
 * overridden with a different implementation by setting the [editor] property.
 */
