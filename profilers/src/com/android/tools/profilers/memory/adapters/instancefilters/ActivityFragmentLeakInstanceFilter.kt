...
open class ActivityFragmentLeakInstanceFilter(classDatabase: ClassDb) :
  ...
  companion object {
    @VisibleForTesting const val ACTIVTY_CLASS_NAME = "android.app.Activity"

    // native android Fragment, deprecated as of API 28.
    @VisibleForTesting const val NATIVE_FRAGMENT_CLASS_NAME = "android.app.Fragment"

    // pre-androidx, support library version of the Fragment implementation.
    @VisibleForTesting const val SUPPORT_FRAGMENT_CLASS_NAME = "android.support.v4.app.Fragment"

    // androidx version of the Fragment implementation
    @VisibleForTesting const val ANDROIDX_FRAGMENT_CLASS_NAME = "androidx.fragment.app.Fragment"
    ...
    private fun isPotentialActivityLeak(instance: InstanceObject): Boolean {
      return isValidDepthWithAnyField(instance, { FINISHED_FIELD_NAME == it || DESTROYED_FIELD_NAME == it }, { it as Boolean })
    }
