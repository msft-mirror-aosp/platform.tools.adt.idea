...
class PsAnalyzerDaemonKtTest {
  ...
  class PsAnalyzerMessagesTest(
    ...
    fun `Expected issue`() {
      ...
      val issues =
        getSdkIndexIssueFor(
          PsArtifactDependencySpec.Companion.create(LIBRARY_GROUP, LIBRARY_ARTIFACT, LIBRARY_VERSION),
          TestPath("testPath"),
          parentModuleRootDir = null,
          sdkIndex = sdkIndex,
        )
      assertThat(issues).hasSize(expectedMessages.size)
      issues.forEachIndexed { index, issue -> assertThat(issue.text).isEqualTo(expectedMessages[index]) }
    }
    ...
    companion object {
      ...
      private const val MESSAGE_POLICY =
      ...
      private const val MESSAGE_POLICY_BLOCKING =
        "<b>[Prevents app release in Google Play Console]</b><br/>\n" +
          "test-group:test-artifact version test-version has<br/>\n" +
          "policy issues that will block publishing of your app to<br/>\n" +
          "Play Console"
      private const val MESSAGE_OUTDATED =
        "test-group:test-artifact version test-version has been<br/>\n" + "reported as outdated by its author"
      private const val MESSAGE_OUTDATED_BLOCKING =
        "<b>[Prevents app release in Google Play Console]</b><br/>\n" +
          "test-group:test-artifact version test-version has been<br/>\n" +
          "reported as outdated by its author and will block<br/>\n" +
          "publishing of your app to Play Console"
      private const val MESSAGE_CRITICAL =
        "test-group:test-artifact version test-version has an<br/>\n" + "associated message from its author"
      private const val MESSAGE_CRITICAL_WITH_NOTE =
        "$MESSAGE_CRITICAL.<br/>\n" +
          "<br/>\n" +
          "<b>Note:</b> More information at <a href=\"http://www.google.com\">http://www.google.com</a>"
      private const val MESSAGE_CRITICAL_BLOCKING =
        "<b>[Prevents app release in Google Play Console]</b><br/>\n" +
          "test-group:test-artifact version test-version has been<br/>\n" +
          "reported as problematic by its author and will block<br/>\n" +
          "publishing of your app to Play Console"
      private const val MESSAGE_CRITICAL_BLOCKING_WITH_NOTE =
        "$MESSAGE_CRITICAL_BLOCKING.<br/>\n" +
          "<br/>\n" +
          "<b>Note:</b> More information at <a href=\"http://www.google.com\">http://www.google.com</a>"
      private const val MESSAGE_POLICY_USER_PERMISSIONS =
        "test-group:test-artifact version test-version has<br/>\n" +
          "Permissions policy, User Data policy issues that will<br/>\n" +
          "block publishing of your app to Play Console in the<br/>\n" +
          "future"
      private const val MESSAGE_POLICY_USER_PERMISSIONS_BLOCKING =
        "<b>[Prevents app release in Google Play Console]</b><br/>\n" +
          "test-group:test-artifact version test-version has<br/>\n" +
          "Permissions policy, User Data policy issues that will<br/>\n" +
          "block publishing of your app to Play Console"
      private const val MESSAGE_VULNERABILITY =
        "test-group:test-artifact version test-version has<br/>\n" + "unspecified vulnerability issues."
      private const val MESSAGE_VULNERABILITY_BLOCKING =
        "test-group:test-artifact version test-version has<br/>\n" + "unspecified vulnerability issues."
      private const val MESSAGE_DEPRECATED =
        "SDK Name (test-group:test-artifact) has been deprecated<br/>\n" +
      ...
      @Parameterized.Parameters(
        name = "{index}: blocking={0}, nonComplaint={1}, outdated={2}, critical={3}, notes={4}, vulnerability={5}, deprecated={6}"
      )
      fun data() =
        listOf(
          // No issues
          ...
          arrayOf(
            ...
            false,
            emptyList<SdkPolicy>(),
            listOf(MESSAGE_POLICY, MESSAGE_OUTDATED, MESSAGE_CRITICAL_WITH_NOTE),
          ),
          ...
          arrayOf(
            ...
            false,
            emptyList<SdkPolicy>(),
            listOf(MESSAGE_POLICY, MESSAGE_OUTDATED, MESSAGE_CRITICAL),
          ),
          ...
          arrayOf(
            ...
            false,
            emptyList<SdkPolicy>(),
            listOf(MESSAGE_POLICY, MESSAGE_VULNERABILITY, MESSAGE_OUTDATED, MESSAGE_CRITICAL_WITH_NOTE),
          ),
          ...
          arrayOf(
            ...
            false,
            emptyList<SdkPolicy>(),
            listOf(MESSAGE_POLICY, MESSAGE_VULNERABILITY, MESSAGE_OUTDATED, MESSAGE_CRITICAL),
          ),
          // Two policies
          arrayOf(
            false,
            ...
            false,
            false,
            listOf(SdkPolicy.SDK_POLICY_USER_DATA, SdkPolicy.SDK_POLICY_PERMISSIONS),
            listOf(MESSAGE_POLICY_USER_PERMISSIONS),
          ),
          ...
          arrayOf(
            ...
            true,
            emptyList<SdkPolicy>(),
            listOf(MESSAGE_DEPRECATED, MESSAGE_POLICY, MESSAGE_VULNERABILITY, MESSAGE_OUTDATED, MESSAGE_CRITICAL_WITH_NOTE),
          ),
          // Policy BLOCKING
          ...
          arrayOf(
            ...
            false,
            emptyList<SdkPolicy>(),
            listOf(MESSAGE_POLICY_BLOCKING, MESSAGE_OUTDATED_BLOCKING),
          ),
          ...
          arrayOf(
            ...
            false,
            emptyList<SdkPolicy>(),
            listOf(MESSAGE_POLICY_BLOCKING, MESSAGE_CRITICAL_BLOCKING_WITH_NOTE, MESSAGE_OUTDATED_BLOCKING),
          ),
          ...
          arrayOf(
            ...
            false,
            emptyList<SdkPolicy>(),
            listOf(MESSAGE_POLICY_BLOCKING, MESSAGE_CRITICAL_BLOCKING, MESSAGE_OUTDATED_BLOCKING),
          ),
          ...
          arrayOf(
            ...
            false,
            emptyList<SdkPolicy>(),
            listOf(MESSAGE_POLICY_BLOCKING, MESSAGE_CRITICAL_BLOCKING_WITH_NOTE, MESSAGE_VULNERABILITY_BLOCKING, MESSAGE_OUTDATED_BLOCKING),
          ),
          ...
          arrayOf(
            ...
            false,
            emptyList<SdkPolicy>(),
            listOf(MESSAGE_POLICY_BLOCKING, MESSAGE_CRITICAL_BLOCKING, MESSAGE_VULNERABILITY_BLOCKING, MESSAGE_OUTDATED_BLOCKING),
          ),
          ...
          arrayOf(
            ...
            false,
            listOf(SdkPolicy.SDK_POLICY_USER_DATA, SdkPolicy.SDK_POLICY_PERMISSIONS),
            listOf(MESSAGE_POLICY_USER_PERMISSIONS_BLOCKING),
          ),
          ...
          arrayOf(
            ...
            listOf(
              MESSAGE_DEPRECATED,
              MESSAGE_POLICY_BLOCKING,
              MESSAGE_CRITICAL_BLOCKING_WITH_NOTE,
              MESSAGE_VULNERABILITY_BLOCKING,
              MESSAGE_OUTDATED_BLOCKING,
            ),
          ),
        )
    }
    ...
    class TestGooglePlaySdkIndex(
      ...
      fun prepareForTest() {
        ...
        labels.severity =
          if (blocking) LibraryVersionLabels.Severity.BLOCKING_SEVERITY else LibraryVersionLabels.Severity.NON_BLOCKING_SEVERITY
        if (nonCompliant) {
        ...
        if (critical) {
          labels.setCriticalIssueInfo(
            LibraryVersionLabels.CriticalIssueInfo.newBuilder().setDescription("More information at http://www.google.com")
          )
        }
        if (vulnerability) {
        ...
        if (deprecated) {
          libraryDeprecation
            ...
            .addAlternativeLibraries(
              AlternativeLibrary.newBuilder().setMavenSdkId(MavenIdentifier.newBuilder().setGroupId("second").setArtifactId("alternative"))
            )
        }
        val proto =
          Index.newBuilder()
                  ...
                  Library.newBuilder()
                    .setLibraryId(
                      LibraryIdentifier.newBuilder()
                        .setMavenId(MavenIdentifier.newBuilder().setGroupId(LIBRARY_GROUP).setArtifactId(LIBRARY_ARTIFACT).build())
                        .build()
                    )
                    .addVersions(
