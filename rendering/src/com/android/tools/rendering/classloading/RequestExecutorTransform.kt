...
/**
 * [ClassVisitor] that makes androidx.core.provider.RequestExecutor#execute a no-op method. This method is used by the AndroidX support
 * library to go fetch downloadable fonts in a separate thread. This should simply be ignored when running in Studio, as it doesn't allow
 * the creation of new threads during rendering, and it has its own way of getting downloadable fonts.
 */
