...
class PluginContainer {
  ...
  private fun getPluginDisplayName(pluginIdentifier: PluginIdentifier, projectPath: String): PluginData.DisplayName =
    when (pluginIdentifier) {
      ...
      else -> PluginData.DisplayName(pluginIdentifier.displayName.cleanUpDisplayName().cleanUpInternalPluginName(), projectPath)
    }
  ...
  private fun String.cleanUpDisplayName(): String {
    val pattern = Pattern.compile("(plugin|plugin class) '(.+)'")
