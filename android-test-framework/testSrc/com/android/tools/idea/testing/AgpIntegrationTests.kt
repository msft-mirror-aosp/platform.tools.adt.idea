...
const val GRADLE_SNAPSHOT_VERSION = "9.7.0-20260614003913+0000"
const val GRADLE_DECLARATIVE_SNAPSHOT_VERSION = "9.5.0"
// For available versions:
// https://maven.pkg.jetbrains.space/kotlin/p/kotlin/dev/org/jetbrains/kotlin/kotlin-compiler/maven-metadata.xml
const val KOTLIN_SNAPSHOT_VERSION = "2.4.20-dev-6612"
...
enum class ModelVersion {
  ...
  companion object {
    val selected: ModelVersion
      get() = if (StudioFlags.GRADLE_SYNC_USE_V2_MODEL.get()) V2 else V1
  }
}
...
private fun AgpVersionSoftwareEnvironmentDescriptor.agpSuffix(): String =
  when (this) {
    ...
    AgpVersionSoftwareEnvironmentDescriptor.AGP_8_10_1 -> "_Agp_8.10_"
