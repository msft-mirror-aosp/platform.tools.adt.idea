...
/**
 * Allows the `com.intellij.platform.ide.progress.withModalProgress` and `com.intellij.platform.ide.progress.runWithModalProgressBlocking`
 * functions to be safely used in headless tests. Without this rule these functions may cause deadlocks when used in headless tests.
 */
