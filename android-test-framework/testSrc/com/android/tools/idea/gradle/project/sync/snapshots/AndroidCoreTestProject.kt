...
enum class AndroidCoreTestProject(
  ...
  APPLICATION_ID_VARIANT_API_BROKEN(
    ...
    patch = { root ->
      root.resolve("app/build.gradle").replaceContent { content ->
        content.replace(
          Regex("androidComponents \\{.*?^}", setOf(RegexOption.MULTILINE, RegexOption.DOT_MATCHES_ALL)),
  ...
  MODULE_INFO_GRADLE_ONLY(TestProjectPaths.MODULE_INFO_GRADLE_ONLY),
  MIGRATE_TO_APP_COMPAT(TestProjectPaths.MIGRATE_TO_APP_COMPAT),
  MIGRATE_TO_VERSION_CATALOG(TestProjectPaths.MIGRATE_TO_VERSION_CATALOG),
  MIGRATE_TO_VERSION_CATALOG_KTS(TestProjectPaths.MIGRATE_TO_VERSION_CATALOG_KTS),
  MIGRATE_TO_VERSION_CATALOG_PLUGINS(TestProjectPaths.MIGRATE_TO_VERSION_CATALOG_PLUGINS),
  ...
  RUN_CONFIG_ALIAS(TestProjectPaths.RUN_CONFIG_ALIAS),
  RUN_CONFIG_WATCHFACE(TestProjectPaths.RUN_CONFIG_WATCHFACE),
  RUN_CONFIG_RUNNER_ARGUMENTS(TestProjectPaths.RUN_CONFIG_RUNNER_ARGUMENTS),
  ...
  UI_TOOLING_DEPENDENCY(TestProjectPaths.UI_TOOLING_DEPENDENCY),
