...
class ComputeAndroidGradlePluginCompatibilityTest(private val info: TestInfo) {
  ...
  fun testComputedCompatibility() {
    ...
    assertEquals(
      "Compatibility for project version ${info.projectVersion} and Studio version ${info.studioVersion}",
      info.expectedCompatibility,
      computed,
    )
  }
  ...
  data class TestInfo(
    ...
    constructor(
      ...
      expectedCompatibility: AndroidGradlePluginCompatibility,
