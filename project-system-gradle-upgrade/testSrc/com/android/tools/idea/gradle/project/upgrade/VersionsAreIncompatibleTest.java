...
public class VersionsAreIncompatibleTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][]{
      {"7.2.0-alpha09", "7.2.0-alpha09", false},
      {"7.2.0-alpha09", "7.2.0-alpha91", true},
      {"7.2.0-alpha09", "7.2.0-alpha10", true},
      {"7.2.0-alpha09", "7.2.0-beta01", true},
      {"7.2.0-alpha09", "7.2.0", true},
      {"7.2.0", "7.2.1", false},
      {"7.2.0", "8.0.0", false},
      {"7.2.0-beta01", "7.3.0-alpha10", true},
      {"7.2.0", "7.3.0-alpha10", false},
      {"7.2.0-alpha01", "7.2.0-dev", false},
      {"7.2.0-alpha08", "7.2.0-alpha08", false},
      {"7.2.0-alpha09", "7.2.0-alpha08", true},
      {"7.3.0", "7.2.0-alpha08", true},
      {"7.3.0-alpha01", "7.2.0-alpha08", true},
      {"7.2.0-alpha01", "7.3.0-alpha08", true},

      // Treat -rc as effectively stable.  (Upgrades will be recommended, but not forced)
      {"7.2.1-rc01", "7.4.0-dev", false},
      {"7.2.1-rc01", "7.4.0-alpha01", false},
      {"7.3.0-rc02", "7.3.0-rc03", false},
      {"7.3.0-rc02", "7.3.0", false},
      {"7.3.0-rc02", "7.4.0", false},

      {"7.3.0-alpha03", "7.3.0-rc01", true},
      {"7.3.0-beta03", "7.3.0-rc02", true},
      {"7.3.0-alpha03", "7.4.0", true},
      {"7.3.0-alpha05", "7.3.0", true},

      {"7.3.0-rc01", "7.4.0-alpha01", false},
      {"7.3.0-rc02", "7.4.0-alpha01", false},
      {"7.2.1", "7.4.0-alpha01", false},

      // Force upgrades from -dev to any later stable version.
      {"7.3.0-dev", "7.3.0", true},
      // Declare AGP -dev incompatible with earlier stable versions.
      {"7.3.0-dev", "7.2.0", true},

      // Do not force upgrades to -dev of prereleases.
      {"7.3.0-alpha01", "7.3.0-dev", false},
      {"7.3.0-beta02", "7.3.0-dev", false},
      {"7.3.0-rc03", "7.3.0-dev", false},

      // Do not force upgrades to -dev of previous-cycle previews.
      {"7.3.0-alpha01", "7.4.0-dev", false},
      {"7.3.0-beta02", "7.4.0-dev", false},
      {"7.3.0-rc03", "7.4.0-dev", false},

      // Force upgrades from -dev of previous-cycle to previews of current cycle.
      {"7.3.0-dev", "7.4.0-dev", true},
      {"7.3.0-dev", "7.4.0-alpha01", true},
      {"7.3.0-dev", "7.4.0-beta02", true},
      {"7.3.0-dev", "7.4.0-rc03", true},

      // Do not force upgrades from -dev to previews of the same cycle.
      {"7.3.0-dev", "7.3.0-alpha01", false},
      {"7.3.0-dev", "7.3.0-beta02", false},
      // But RCs are treated like releases.
      {"7.3.0-dev", "7.3.0-rc03", true},
    });
  }
