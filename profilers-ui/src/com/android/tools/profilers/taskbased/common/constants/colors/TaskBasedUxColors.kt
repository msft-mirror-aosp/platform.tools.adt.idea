 ...
 */
package com.android.tools.profilers.taskbased.common.constants.colors

import org.jetbrains.jewel.bridge.retrieveColorOrUnspecified

object TaskBasedUxColors {
  // Background color of a task grid item once selected.
  val TASK_SELECTION_BACKGROUND_COLOR
    get() = retrieveColorOrUnspecified("TabbedPane.focusColor")

  // Background color of a task grid item on hover.
  val TASK_HOVER_BACKGROUND_COLOR
    get() = retrieveColorOrUnspecified("TabbedPane.hoverColor")

  // Process and past recording table colors.
  val TABLE_ROW_SELECTION_BACKGROUND_COLOR
    get() = retrieveColorOrUnspecified("Table.selectionBackground")

  val TABLE_HEADER_BACKGROUND_COLOR
    get() = retrieveColorOrUnspecified("TableHeader.background")
