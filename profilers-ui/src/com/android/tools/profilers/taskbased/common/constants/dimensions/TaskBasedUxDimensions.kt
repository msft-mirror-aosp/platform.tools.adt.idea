...
object TaskBasedUxDimensions {
  ...
  // Task grid dimensions (V2)
  val TASK_WIDTH_V2_DP = 230.dp
  val TASK_HEIGHT_V2_DP = 120.dp
  val TASK_GRID_HORIZONTAL_SPACE_V2_DP = 24.dp
  ...
  val LEAKCANARY_SEARCH_BAR_WIDTH_DP = 225.dp
  val LEAKCANARY_LEAK_TYPE_COL_WIDTH_DP = 75.dp
  val LEAKCANARY_OCCURRENCE_COL_WIDTH_DP = 90.dp
  val LEAKCANARY_TOTAL_LEAKED_COL_WIDTH_DP = 85.dp

  // LeakCanary LeakDetail dimensions
  val LEAKCANARY_PANE_HEADER_HEIGHT_DP = 34.dp
