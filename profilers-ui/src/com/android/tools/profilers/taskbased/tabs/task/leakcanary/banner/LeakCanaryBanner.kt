...
import com.android.tools.profilers.taskbased.common.constants.strings.TaskBasedUxStrings.LEAKCANARY_BANNER_MESSAGE
import com.android.tools.profilers.taskbased.common.constants.strings.TaskBasedUxStrings.LEAKCANARY_EDIT_CONFIGURATION
...
@Composable
fun LeakCanaryBanner(onBannerClose: () -> Unit, onBannerDoNotAskAgainClick: () -> Unit, onEditConfigurationClick: () -> Unit) {
  Column {
    LeakCanaryBannerBorderLine()
    Row(
      ...
      EllipsisText(text = LEAKCANARY_BANNER_MESSAGE)
      Spacer(modifier = Modifier.weight(1f))
      Link(LEAKCANARY_EDIT_CONFIGURATION, onClick = { onEditConfigurationClick() }, overflow = TextOverflow.Ellipsis)
