...
import com.android.tools.idea.device.explorer.files.mocks.MockDeviceFileSystemManager
...
class DeviceFileDownloaderServiceImplTest : AndroidTestCase() {
  ...
  private lateinit var mockDeviceFileSystemManager: MockDeviceFileSystemManager
  ...
  override fun setUp() {
    ...
    mockDeviceFileSystemManager = MockDeviceFileSystemManager()
    mockDeviceFileSystem = mockDeviceFileSystemManager.addDevice("fileSystem")
    deviceFileDownloaderService = DeviceFileDownloaderServiceImpl(mockDeviceFileSystemManager, myDeviceExplorerFileManager)
    ...
    fooBar1LocalPath = Paths.get(FileUtil.toSystemDependentName(FileUtilRt.getTempDirectory() + "/fileManagerTest/fileSystem/foo/bar1"))
