...
import com.android.tools.idea.templates.diff.activity.GoldenFileValidator
...
class NewProjectKotlinVersionTest {
  ...
  /** This test must be run using Bazel, since it uses the TemplateDiffTest golden file generator */
  @Test
  fun latestKotlinVersionUsedForNewProjects() {
    val template = TemplateResolver.getTemplateByName("Empty Activity")!!
    val renderer = GoldenFileValidator(template, goldenDirName = "testComposeActivityMaterial3", projectRule)
